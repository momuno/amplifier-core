...
- `.doc-gen/cache/` - Storage for registered outlines, if does not exist
...
- Outline storage directory at `.doc-gen/cache/`
...
This:
1. Copies outline to `.doc-gen/cache/docs-api-overview/overview_outline.json`
...
vim .doc-gen/cache/docs-api-overview/overview_outline.json
...
```
docs/api/overview.md → .doc-gen/cache/docs-api-overview/overview_outline.json
```
...
See `.doc-gen/cache/` for real-world examples:
