...
Amplifier Core is an ultra-thin kernel (~2,600 lines) following the Linux kernel model: a tiny, stable center that rarely changes, with all policies and features implemented as replaceable modules at the edges.
...
- Minimal context plumbing (session_id, parent_id)
